 ...
 *
 * Example :  10 5 6 * +
 * The above expression evaluates to 40
 *
 * Note : The operations supported are +, -, /, *, lg base 2, sin
 */
...
public class Parse {
    ...
    /*
    The following methods return the respective instance of the operator expression that is to be evaluated.
    */
